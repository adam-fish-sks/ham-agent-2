...
| **team** _NEW_               | String   | Yes      | **Team name** - Used in asset location details           |
| **foreignId** _NEW_          | String   | Yes      | **External system reference**                            |
| **registrationStatus** _NEW_ | String   | Yes      | **Registration status** (Uninvited, Invited, Registered) |
| **isDeactivated** _NEW_      | Boolean  | No       | **Active/inactive status** - Default: false              |
| **userId** _NEW_             | String   | Yes      | **Workwize user account ID**                             |
...
| Field      | Type   | Nullable | Notes                                                |
| ---------- | ------ | -------- | ---------------------------------------------------- |
| id         | String | No       | UUID for employees, "warehouse\_{id}" for warehouses |
...
| **serialCode** _RENAMED_      | String   | Yes         | **Was: serialNumber** - Serial number from API       |
...
| **invoicePrice** _RENAMED_    | Decimal  | Yes         | **Was: purchasePrice** - Invoice price from API      |
| **invoiceCurrency** _RENAMED_ | String   | Yes         | **Was: currency** - Invoice currency from API        |
...
| **warehouseStatus** _NEW_     | String   | Yes         | **Warehouse status** (available, in_repair, unknown) |
| **condition** _NEW_           | String   | Yes         | **Asset condition** (new, used)                      |
| **tags** _NEW_                | Json     | Yes         | **Array of tag objects** from API                    |
| **externalReference** _NEW_   | String   | Yes         | **External reference** from API                      |
...
| **warehouseProvider** _NEW_ | String | Yes          | **Provider name** (e.g., "logistic_plus") |
...
| status               | String | Yes          | Operational status                     |
| **employerId** _NEW_ | String | Yes          | **Employer/company ID** from API       |
| **managerId** _NEW_  | String | Yes          | **Manager user ID** from API           |
...
| **poNumber** _NEW_        | String   | Yes         | **Purchase order number**                       |
| **totalProducts** _NEW_   | Int      | Yes         | **Number of products** in order                 |
| **receiver** _NEW_        | String   | Yes         | **Receiver name**                               |
| **receiverType** _NEW_    | String   | Yes         | **Receiver type** (employee, office, warehouse) |
| **expressDelivery** _NEW_ | Boolean  | No          | **Express shipping** - Default: false           |
| **shippingInfo** _NEW_    | Json     | Yes         | **Complete shipping address** as JSON           |
